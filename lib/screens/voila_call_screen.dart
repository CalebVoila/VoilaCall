...
class _VoilaCallScreenState extends State<VoilaCallScreen> {
  ...
  void submitData() async {
    ...
    await DatabaseHelper.insertCustomer({
      DatabaseHelper.customersColName: name,
      DatabaseHelper.customersColPhoneNumber: phoneNumber,
      DatabaseHelper.customersColComment: comment,
      DatabaseHelper.customersColCallType: callType,
      DatabaseHelper.customersColCallTag: callTag,
      DatabaseHelper.customersColDate: callDate,
      DatabaseHelper.customersColLead: selectedLead,
      DatabaseHelper.customersColDuration: callDuration,
